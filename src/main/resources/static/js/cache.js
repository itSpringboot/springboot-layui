        ...
        layer.open({
            ...
            content :  '<div class="functionSrtting_box">'+
                            '<form class="layui-form">'+
                                ...
                                '<div class="layui-form-item">'+
                                    ...
                                    '<dl class="clearfix iteminfo_parameter sys_item_specpara" data-sid="1" data-attrval='+(window.sessionStorage.getItem("menutype"))+'>'+
            '<dd>'+
                '<ul class="sys_spec_img">'+
                '<li data-aid="1" class='+(window.sessionStorage.getItem("menutype")==1?"selected":"")+'>'+
                '<a href="javascript:;"><img id="1" onClick="test(this.id)" src="'+context+'/skins/skin/layui/images/chlidone.jpg" width="219" height="118"  /></a>'+
                '<span>左侧结构菜单</span>'+
                '<i></i>'+
                '</li>'+
                '<li data-aid="2" class='+(window.sessionStorage.getItem("menutype")==2?"selected":"")+'>'+
                '<a href="javascript:;"><img id="2" onClick="test(this.id)" src="'+context+'/skins/skin/layui/images/chlidtwo.jpg" width="219" height="118"   /></a>'+
                '<span>上下结构菜单</span>'+
                '<i></i>'+
                '</li>'+
                '</ul>'+
            ...
            success : function(index, layero){
                ...
                form.on("submit(settingSuccess)",function(data){
                    ...
                    window.sessionStorage.removeItem("menu");
                    window.sessionStorage.removeItem("curmenu");
                    window.sessionStorage.setItem("menutype",data.field.menutype);
                    location.reload();
                    return false;
                });
                //取消设定
                ...
                form.render();  //表单渲染
                $(".layui-form-item .sys_item_specpara").each(function(){
                    var i=$(this);
                    var p=i.find("ul>li");
                    p.click(function(){
